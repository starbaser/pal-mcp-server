...
4. Generated code is saved to a timestamped `.code` file in the PAL persistent store (`~/.claude/pal/code/`)
...
3. PAL saves the code to a timestamped file in `~/.claude/pal/code/` and instructs your AI agent where to read it
