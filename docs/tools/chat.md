...
- **Structured code generation**: When using GPT-5.2 or Gemini 3.0 / 2.5 Pro, get complete, production-ready implementations saved to the PAL persistent store (`~/.claude/pal/code/`) for your CLI to review and apply
...
3. PAL saves the code to a timestamped `.code` file in `~/.claude/pal/code/` and instructs your AI agent where to read it
