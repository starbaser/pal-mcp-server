"""ZAI (GLM) model provider implementation using the Anthropic-compatible API."""
...
class ZAIModelProvider(AnthropicSDKProviderMixin, RegistryBackedProviderMixin, ModelProvider):
    """Integration for ZAI's GLM models via Anthropic-compatible API."""
