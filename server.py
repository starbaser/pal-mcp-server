...
def get_follow_up_instructions() -> str:
    """Generate follow-up instructions for conversation continuation."""
    return """

CONVERSATION CONTINUATION: You can continue this discussion with the agent!
...
async def reconstruct_thread_context(arguments: dict[str, Any]) -> dict[str, Any]:
    ...
    enhanced_arguments["_context_window"] = token_allocation.total_tokens
    enhanced_arguments["_context_used"] = conversation_tokens
