...
class TestOpenRouterProvider:
    ...
    def test_model_alias_resolution(self):
        ...
        assert provider._resolve_model_name("grok") == "x-ai/grok-4.20-0309-reasoning"
...
class TestOpenRouterRegistry:
    ...
    def test_registry_capabilities(self):
        ...
        assert caps.context_window == 1048576  # Opus 4.6 has 1M context
        ...
        # Test opus4.5 alias still works
